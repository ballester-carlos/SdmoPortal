...
namespace SdmoPortal.Controllers
{
    ...
    public class ApplicationUsersController : Controller
    {
        ...
        public ApplicationUsersController(ApplicationUserManager userManager, ApplicationRoleManager roleManger)
        {
        ...
        //TO DO: private ApplicationDbContext db = new ApplicationDbContext();
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Id")] ApplicationUser applicationUser, params string[] rolesSelectedOnView)
        {
            if (ModelState.IsValid)
            {
                // If the user is currently store having the admin role
                ...
                // and the current stored count of users with Admin role == 1
                ...
                {
                    ModelState.AddModelError("","At leat on user must retain the Admin role; you are attempting to delete the Admin role.");
                    return View(applicationUser);
                }
