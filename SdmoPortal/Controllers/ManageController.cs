...
namespace SdmoPortal.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // TO DO: Add this action method for change profile
        ...
        public async Task<ActionResult> ChangeProfie(ApplicationUser applicationUser)
        {
            ...
            if(result.Succeeded)
            {
                ...
                //If the email address change, sync both Email and UserName to it
        ...
        // TO DO: Comment both EnableTwoFactorAuthentication AND DisableTwoFactorAuthentication 
...
#region Helpers
        ...
        // TO DO: Add ChangeProfileSuccess and ChangeEmailSuccess enum items
